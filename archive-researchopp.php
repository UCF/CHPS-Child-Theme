				...
				<div class="row mb-1">
					<div class="col-lg-12 p-3"> 
						<h2 class="h4"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
							...
							<i class="fas fa-clock-o iconyellow" style="margin-left:30px;"></i> Deadline: <?php echo $deadlineShort; ?>
							<i class="fa fa-usd iconyellow" style="margin-left:30px;"></i> <?php if ($payment == 'Yes') { echo 'Paid'; } else { echo 'None'; } ?>
