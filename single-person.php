							...
							<div class="wpb_wrapper">
								...
								<div class="mb-4">
									...
									<ul>
										...
										<li><a href="<?php the_sub_field('exnews_link'); ?>" title="<?php the_sub_field('exnews_title'); ?>" target="_blank"><?php the_sub_field('exnews_title'); ?></a>, <span style="color: #888; font-style: italic;"><?php the_sub_field('exnews_platform'); ?></span>
												</li>
