					...
					<?php if( $peepargs ): ?>
						...
						<div class="wpb_text_column wpb_content_element " >
							<div class="wpb_wrapper">
								...
								<span class="authortext">Written By: <?php if(get_field('overwrite_author')){ the_field('overwrite_author');} else { get_the_author_meta($peeparg->ID); }?> | <?php the_time('F j, Y', $peeparg->ID); ?></span>
								<br>
								<?php 			
