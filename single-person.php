					...
					<?php if( $peepargs ): ?>
						...
						<div class="wpb_text_column wpb_content_element " >
							<div class="wpb_wrapper">
								...
								<span class="authortext">Written By: <?php if(get_field('overwrite_author')){ the_field('overwrite_author');} else { echo get_the_author_meta( 'display_name', $peeparg->ID ); }?> | <?php the_time('F j, Y', $peeparg->ID); ?></span>
								<span class="authortext">Written By: <?php get_the_field('overwrite_author', $peeparg->ID);?> <?php echo get_the_author_meta( 'display_name', $peeparg->ID );?> | <?php echo get_the_time('F j, Y', $peeparg->ID); ?></span>
