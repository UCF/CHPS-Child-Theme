						...
						<div class="wpb_text_column wpb_content_element " >
							<div class="wpb_wrapper">
								...
								<div class="vc_btn3-container  btnhover-black vc_btn3-left" >
									<a style="background-color:#000000; color:#ffffff; font-size: 16px; padding: 18px 25px; text-decoration: none;" class="vc_general vc_btn3 vc_btn3-size-lg vc_btn3-shape-square vc_btn3-style-custom vc_btn3-icon-left" href="https://google.com" title="" target="_blank"><i class="vc_btn3-icon fa fa-bookmark"></i> View Bibliography</a>
								</div>
								<?php }?>
							</div>
						</div>
