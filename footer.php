    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-md-5">
				...
				<a class="giveBTN mt-4" href="https://www.ucffoundation.org/athletictraining" target="_blank"><i class="fa-solid fa-heart"></i> Support UCF Communication Sciences and Disorders</a>
			</div>
			<div class="col-md-2">
			</div>
        </div>
