...
//
// [chpsnews category="" cattwo="" catthree="" number=""]
...
$cattwo_id = get_cat_ID($c['cattwo']);
$catthree_id = get_cat_ID($c['catthree']);
		$chpsnews = new WP_Query(array(
				...
				'category__in' => array( $category_id, $cattwo_id, $catthree_id ),
				)
			);
