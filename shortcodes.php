...
<div class="container newsmedia"><div class="row narrow-gutter row-flex"><?php while($visualnews->have_posts()) : $visualnews->the_post(); $getimgURL = wp_get_attachment_image_src( get_post_thumbnail_id(), 'large', false )[0];	?><?php if ($a['column'] == '3') { ?><div class="col-lg-4 col-sm-6 col-xs-12"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><div class="visnews"><div class="media-background-container visnews-photo mx-auto"><?php } else { ?><div class="col-lg-3 col-sm-6 col-xs-12"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><div class="visnews"><div class="media-background-container visnews-photo mx-auto"><?php } ?><?php if ( has_post_thumbnail()) { ?><img src="<?php echo $getimgURL; ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" class="media-background object-fit-cover"><?php } else { ?><img src="<?php the_field('default_news_image', 'option'); ?>" alt="<?php the_title_attribute(); ?>" title="<?php the_title_attribute(); ?>" class="media-background object-fit-cover"><?php } ?></div><div class="p-3"><?php the_title(); ?><p class="newsdate"><?php the_time('F j, Y'); ?></p></div></div></a></div><?php endwhile; ?></div></div>
<?php wp_reset_query();  restore_current_blog(); }
