		...
		<div class="col-md-4 pl-0 pr-0" style="background-color: #f2f2f2">
			...
			<div class="researchOpp-dblock hidemobile"> 
				<div class="btnhover-yellow" style="width: 100%" >
					<a href="#getStarted" title="" style="width: 100%; font-size: 16px; margin: 15px 0px; padding: 18px 25px; text-align: center; background-color:#ffcc00; color:#000000;" class="vc_general vc_btn3 vc_btn3-size-lg vc_btn3-shape-square vc_btn3-style-custom vc_btn3-block">Participate!</a>
				</div>
